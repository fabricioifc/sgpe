...
private
  ...
  def offer_discipline_params
    params.require(:offer_discipline).permit(:id, :grid_discipline_id, :user_id, :second_user_id, :active, :offer_id, :turmas_id, :ead_percentual_maximo, :ead_percentual_definido,
